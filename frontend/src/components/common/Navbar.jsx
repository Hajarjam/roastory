      ...
      <div className="hidden md:flex items-center gap-3 ml-8">
        {!isAuthenticated ? (
          ...
          <>
            ...
            >
              {totalQty > 0 && (
                <span className="absolute -top-2 -right-2 min-w-5 h-5 px-1 rounded-full bg-white text-black text-[10px] font-semibold leading-none flex items-center justify-center">
